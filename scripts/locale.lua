...
Locale = {
	LocaleData = {
		en_us = {
			...
			action_wheel__main__action_5 = "Wing opacity §7(Scroll)§r: ",
            action_wheel__main__action_6 = "Wing glowing: ",
			action_wheel__main__action_7 = "Wing particle duration §7(Scroll)§r: ",
            action_wheel__main__action_7__none = "None",
            action_wheel__main__action_7__short = "Short",
            action_wheel__main__action_7__normal = "Normal",
            action_wheel__main__action_7__long = "Long",
			action_wheel__main__action_7__very_long = "Very long",
			action_wheel__color_picker__message_fast_scroll = "\n§bYou can scroll quickly with holding sprint key!",
			action_wheel__color_picker__message__done = "Changed target color!",
			...
			action_wheel__color_picker__action_5__copy = "Copied current color!",
			action_wheel__color_picker__action_5__paste = "Pasted copied color!",
			action_wheel__color_picker__action_5__no_paste_color = "No color to paste!",
		...
		ja_jp = {
            ...
            action_wheel__main__action_5 = "羽の不透明度§7（スクロール）§r：",
            action_wheel__main__action_6 = "羽の発光：",
            action_wheel__main__action_7 = "羽のパーティクルの出現時間§7（スクロール）§r：",
            action_wheel__main__action_7__none = "なし",
            action_wheel__main__action_7__short = "短い",
            action_wheel__main__action_7__normal = "ふつう",
            action_wheel__main__action_7__long = "長い",
            action_wheel__main__action_7__very_long = "とても長い",
			action_wheel__color_picker__message_fast_scroll = "\n§bダッシュキーを押しながら素早くスクロールできます！",
			action_wheel__color_picker__message__done = "色を変更しました！",
			...
			action_wheel__color_picker__action_5__copy = "現在の色をコピーしました！",
			action_wheel__color_picker__action_5__paste = "色を貼り付けました！",
			action_wheel__color_picker__action_5__no_paste_color = "貼り付ける色がありません！",
