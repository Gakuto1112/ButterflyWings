...
function pings.syncAvatarConfig(colors, wingOpacity, wingGlow, flyingFlag, slowFallFlag)
	if host:isHost() then
...
events.TICK:register(function ()
	if Config.NextSyncCount == 0 then
		pings.syncAvatarConfig(Color.Color, Color.Opacity, Wing.Glowing, Wing.Flying, Wing.SlowFallEffect)
